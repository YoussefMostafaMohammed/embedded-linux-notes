...
### **Part 7: procfs Deep Dive**
10. [procfs vs Character Devices - Complete Guide](#10-procfs-vs-character-devices---complete-guide)
    - 10.1 [Context: procfs vs Character Devices](#101-context-procfs-vs-character-devices)
    - 10.2 [The proc_ops Structure (Linux v5.6+)](#102-the-proc_ops-structure-linux-v56)
      - 10.2.1 [Why the Change from file_operations?](#1021-why-the-change-from-file_operations)
      - 10.2.2 [Structure Comparison - Old vs New](#1022-structure-comparison---old-vs-new)
      - 10.2.3 [Function Signature Changes](#1023-function-signature-changes)
      - 10.2.4 [Key Differences Summary](#1024-key-differences-summary)
    - 10.3 [Writing Version-Compatible procfs Code](#103-writing-version-compatible-procfs-code)
      - 10.3.1 [Conditional Compilation Pattern](#1031-conditional-compilation-pattern)
      - 10.3.2 [proc_create() Usage](#1032-proc_create-usage)
    - 10.4 [Complete procfs Example](#104-complete-procfs-example)
      - 10.4.1 [Module Code](#1041-module-code)
      - 10.4.2 [Makefile](#1042-makefile)
      - 10.4.3 [Testing Commands](#1043-testing-commands)
    - 10.5 [When to Use proc_create_single()](#105-when-to-use-proc_create_single)
    - 10.6 [Summary Table - Character Devices vs procfs](#106-summary-table---character-devices-vs-procfs)

### **Part 8: procfs Practical Implementation**
11. [The /proc Filesystem - Practical Implementation](#11-the-proc-filesystem---practical-implementation)
    - 11.1 [Basic Concepts and Rationale](#111-basic-concepts-and-rationale)
      - 11.1.1 [Why You Need procfile](#1111-why-you-need-procfile)
      - 11.1.2 [Why to Use It](#1112-why-to-use-it)
      - 11.1.3 [What Happens Without procfile](#1113-what-happens-without-procfile)
      - 11.1.4 [Write Operations on procfile - Are They Needed?](#1114-write-operations-on-procfile---are-they-needed)
      - 11.1.5 [When to Use procfile (Not Just for Debugging)](#1115-when-to-use-procfile-not-just-for-debugging)
    - 11.2 [The proc_ops Structure in Depth](#112-the-proc_ops-structure-in-depth)
      - 11.2.1 [Definition and Purpose](#1121-definition-and-purpose)
      - 11.2.2 [Performance Optimizations with proc_flags](#1122-performance-optimizations-with-proc_flags)
      - 11.2.3 [Backward Compatibility with file_operations](#1123-backward-compatibility-with-file_operations)
    - 11.3 [Read and Write a /proc File - Complete Walkthrough](#113-read-and-write-a-proc-file---complete-walkthrough)
      - 11.3.1 [proc_callback_read() Implementation](#1131-procfile_read-implementation)
      - 11.3.2 [proc_callback_write() Implementation](#1132-procfile_write-implementation)
      - 11.3.3 [The Offset Parameter - Critical Detail](#1133-the-offset-parameter---critical-detail)
      - 11.3.4 [Full Example: procfs1.c](#1134-full-example-procfs1c)
      - 11.3.5 [Full Example: procfs2.c](#1135-full-example-procfs2c)
    - 11.4 [Manage /proc file with Standard Filesystem](#114-manage-proc-file-with-standard-filesystem)
      - 11.4.1 [struct inode_operations and Permissions](#1141-struct-inode_operations-and-permissions)
      - 11.4.2 [module_permission() Function](#1142-modulepermission-function)
      - 11.4.3 [Full Example: procfs3.c](#1143-full-example-procfs3c)
    - 11.5 [Manage /proc file with seq_file](#115-manage-proc-file-with-seq_file)
      - 11.5.1 [seq_file API Overview](#1151-seq_file-api-overview)
      - 11.5.2 [Sequence Functions: start(), next(), stop(), show()](#1152-sequence-functions-start-next-stop-show)
      - 11.5.3 [How seq_file Works - The Loop](#1153-how-seq_file-works---the-loop)
      - 11.5.4 [Diagram: seq_file Operation](#1154-diagram-seq_file-operation)
      - 11.5.5 [Full Example: procfs4.c](#1155-full-example-procfs4c)
      - 11.5.6 [Benefits of seq_file](#1156-benefits-of-seq_file)
    - 11.6 [procfs Best Practices](#116-procfs-best-practices)
      - 11.6.1 [When to Use procfs vs sysfs](#1161-when-to-use-procfs-vs-sysfs)
      - 11.6.2 [Security Considerations](#1162-security-considerations)
      - 11.6.3 [Performance Tips](#1163-performance-tips)

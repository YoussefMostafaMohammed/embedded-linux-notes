...
Without modules, Linux would be a **monolithic kernel** where every driver and feature is statically compiled into one massive `/boot/vmlinuz` file. The consequences:
